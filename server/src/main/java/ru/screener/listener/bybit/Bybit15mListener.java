...
@Component
@Slf4j
public class Bybit15mListener extends AbstractKafkaListener<RsiDto> {

    private final StrategyProcessor<RsiDto> strategyProcessor;
    private final CaffeineDeduplicationService deduplicationService;

    public Bybit15mListener(StrategyProcessor<RsiDto> strategyProcessor,
    ...
    @KafkaListener(topics = "${app.kafka.topic.bybit15m.name}",
